    ...
    <head>
        ...
        <?php    
         ...
         /* $hName = $_POST['hotelName'];
            ...
            $_SESSION['UpDateCicked'] = FALSE;
            $_SESSION['DeleteClicked'] = TRUE;
       ...
       <div id="wrapper" >
            ...
            <section>
                ...
                <div id="insertDBFormContainer" class="dbInterfaceFormContainer" style="margin-left: 400px; width: 50%">
                    <h1 id="insrtDB_formTitle" >Delete data from the database</h1>
                    <form id="insertDBform" method="POST" action="deleteHotelProcess.php">
                        ...
                        <div class="classDetailDiv">
                         ...
                         <div class="classDetailDiv">
                          ...
                          -->  
                            <input type="submit" value="Delete" id="insertSubmitButton"> 
                            </div>
